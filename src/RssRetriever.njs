...
Retriever.prototype.retrieve.debug = require('debug')('StockTracker:rss:retriever');
...
Retriever.prototype._hasFeedChanged.debug = require('debug')('StockTracker:rss:hasFeedChanged')
...
Retriever.prototype._request.debug = require('debug')('StockTracker:rss:_request')
...
Retriever.prototype._getBody.debug = require('debug')('StockTracker:rss:_getBody');
